...
namespace Spacegrass;

use InvalidArgumentException;
use Spacegrass\Exception\Fraction\InvalidDenominatorException;
use Spacegrass\Exception\Fraction\InvalidNumeratorException;
...
class Fraction
{
     ...
     * @return bool
     */
    public static function isFraction($string)
    {
        return (bool) preg_match(self::PATTERN_FROM_STRING, trim($string));
    }
