...
/*
 * This file is part of the Spacegrass Fraction package.
 *
 * For the full copyright and license information, please view the LICENSE
 * file that was distributed with this source code.
 */

namespace Spacegrass\Tests;
...
class FractionTest extends TestCase
{
     ...
     * @since  0.1.0
     *
     * @expectedException Spacegrass\Exception\Fraction\InvalidDenominatorException
     ...
     * @since  0.1.0
     *
     * @expectedException Spacegrass\Exception\Fraction\InvalidNumeratorException
     * @dataProvider badIntegerProvider
     */
     ...
     * Test isFraction
     *
     * @author Dallin Coons <dallinis@hotmail.com>
     *
     * @dataProvider fromIsFraction
     */
    public function testIsFraction($toTest, $isFraction)
    {
        $this->assertSame(
            $isFraction,
            Fraction::isFraction($toTest)
        );
    }

    /**
     * fromIsFraction provider
     *
     * @return array
     */
    public static function fromIsFraction()
    {
        return [
            ['1/3', true],
            ['88/99', true],
